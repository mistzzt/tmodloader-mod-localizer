...
namespace ModLocalizer
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            var dump = true;
            string folder = null, path = null, language = DefaultConfigurations.DefaultLanguage;
        ...
        private static void ProcessInput(string modPath, string contentFolderPath, bool dump = true, string language = DefaultConfigurations.DefaultLanguage)
        {
